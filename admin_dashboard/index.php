          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <ul class="navbar-nav flex-column mt-4">
                <li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-address-book text-light fa-lg mr-3"></i>Rezervimet</a></li>
          ...
          <div class="col-xl-10 col-lg-9 col-md-8 ml-auto">
            <div class="row align-items-center">
              <div class="col-xl-12 col-12 mb-4 mb-xl-0">
                <h3 class="text-muted text-center mb-3">Reazevimet</h3>
 ...
 <table class="table table-striped bg-light text-center">
                  <thead>
                    <tr class="text-muted">
                      ...
                      <th>Koha e qendrimit</th>
                      <th>Nr i personave</th>
                      <th colspan='1'>Veprime</th>
...
while($row=$result->fetch_assoc()):?><!--data fetch-->
                  ...
                  <tbody>
                    ...
                    <td><?php echo $row['nr_personave']?></td>
                    <td><a class='btn btn-danger' href="veprime.php?delete=<?php echo $row['id']; ?>">Fshij </a>   </td>
