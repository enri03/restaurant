...
<html lang="en">
          ...
          <div class="row">
            ...
            <div class="col-xl-2 col-lg-3 col-md-4 sidebar fixed-top">
              ...
              <ul class="navbar-nav flex-column mt-4">
                ...
                <li class="nav-item"><a href="#" class="nav-link text-white p-3 mb-2 current"><i class="fas fa-comment text-light fa-lg mr-3"></i>Posta</a></li>
  ...
  $result=  $conn->query("SELECT * FROM sms") or die($conn->error);
...
while($row=$result->fetch_assoc()):?><!--data fetch-->
                  ...
                  <tbody>
                    ...
                    <td><a class='btn btn-danger' href="veprime.php?delete1=<?php echo $row['id']; ?>">Fshij </a>   </td>
